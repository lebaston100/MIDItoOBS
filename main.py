        ...
        if self.block == True:
            ...
            for result in results:
                ...
                if input_type == "fader":
                    ...
                    if command in ["SetSourceScale", "SetGainFilter", "SetOpacity", "SetColorCorrectionHueShift"]:
                    ...
                    if command in ["SetSourceRotation", "SetTransitionDuration", "SetSyncOffset", "SetSourcePosition"]:
